  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Admin Panel | Admin Logging
          </h1>
          <ol class="breadcrumb">
            <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Admin Logging</li>
          </ol>
        </section>
            ...
            <div class="col-md-12" >
              <div class="box box-success">
                <div class="box-header with-border">
                  <h3 class="box-title" id="adminlogging"><i class="fa fa-clock-o"></i> Admin Logging</h3>
                  <div class="box-tools pull-right">
                    ...
                    <button class="btn btn-xs btn-danger" onclick="selectlog()"><i class="fa fa-trash"></i> <span class="hidden-xs">Delete</span></button>
                  </div>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <div class='col-xs-12'>
                    <table id="adminlogtable" class="display responsive nowrap" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                <th>Select</th><th>Log ID</th><th>Admin ID</th><th>Username</th><th>Date Time</th><th>IP Address</th><th>Country Name</th><th>	Latitude</th><th>	Longitude</th>
                            </tr>
                        </thead>
                        <tfoot>
                            <tr>
      ...
      <div id="exmodal" class="modal fade" role="dialog">
			  <div class="modal-dialog">
			    ...
			    <div class="modal-content">
			      ...
			      <form id="exportform" method="POST" action="asset/php/export.php?table=log">
			      	<div class="form-group">
							<label for="exname">Export file name:</label>
						 <input type="text" class="form-control" name="ename" id="ename" value="adminlog_<?php echo date('Y-m-d');?>">
					 </div>
					 <div class="form-group">
    ...
    $(document).ready(function() {
      ...
      $('#adminlogtable').DataTable( {
          "processing": true,
          "serverSide": false,
          "ajax": "asset/php/adminfunction.php?act=shlog",
          "paging":   true,
            "ordering": true,
            "info":     true
      } );
